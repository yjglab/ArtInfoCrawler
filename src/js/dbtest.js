...
const dbtest = async () => {
  ...
  await ExbModel.insertMany([
    ...
    {
      country: `Brazil`,
      title: `Memorial a Casa do Rio Vermelho - Jorge Amado e Zélia Gattai`,
      date: `Permanent`,
      thumbnailSrc: `http://www.secult.salvador.ba.gov.br/images/noticias/fora-da-toca_casa-do-rio-vermelho_01.jpg`,
      detail: `Depois de 11 anos fechada, a casa de número 33 da Rua Alagoinhas, no bairro do Rio Vermelho, na cidade de Salvador, Bahia, onde viveu o casal de escritores Jorge Amado e Zélia Gattai, está aberta para visitação. O imóvel foi totalmente reformado pela Prefeitura do Salvador, numa intervenção que contou com a participação da Fundação Casa de Jorge Amado, da família do casal que encarna e simboliza mundo afora a cultura baiana e do arquiteto e cenógrafo Gringo Cardia, que assume a curadoria do museu. História contada por amigos e admiradores - Comprada em 1960 com dinheiro da venda dos direitos do livro “Gabriela, Cravo e Canela”, de Jorge Amado, para a MGM, a casa mais tarde se transformou no título do livro de Zélia Gattai publicado em 2002 contando a história vivida pelo casal quando residiu no imóvel. No local, os escritores receberam visitas ilustres, como Glauber Rocha, Pablo Neruda, Tom Jobim, Dorival Caymmi, Roman Polanski, Jack Nicholson, Sartre e Simone de Beauvoir, só para citar alguns. Toda essa riqueza é contada nos diversos ambientes da casa, com seus mais de dois mil metros quadrados, incluindo o jardim onde as cinzas de Jorge e Zélia estão depositadas. A Casa do Rio Vermelho conta com mais de 30 horas de vídeos e projeções. Ou seja, é impossível conhecer toda a história do imóvel e do casal de escritores em apenas uma visita. Para tornar mais didática a experiência de mergulhar na intimidade de Jorge Amado e Zélia Gattai, a casa foi dividida em vários espaços, mantendo sempre as características originais, o rico acervo e documentos importantes, como cartas trocadas com personalidades nacionais e internacionais. Os ambientes foram batizados de “A Bahia de Jorge Amado”, “A amizade é o sal da vida”, “A infância/Memórias de Dona Lalú”, “Os viajantes”, “Varanda”, “Amores e amantes amadianos”, “Zélia Gattai, companheira graças a Deus”, “Trocando cartas/O comunista”, “Sala de leituras”, “Muita vida, tantas obras”, “Os amados sabores de Jorge”, “Cozinha de Dona Flor”, “Lago dos Sapos”, “Roda de conversa”, e “Jorge e o Candomblé”. Ambientes da Casa: O quarto onde dormiam Jorge Amado e Zélia Gattai, espaço chamado de “Amores e amantes amadianos”, agora está visualmente povoado por personagens marcantes como Gabriela e Nacib, ilustrados em obras de artistas como Calazans Neto, Carybé e Floriano Teixeira. O visitante pode ainda ouvir narrações de trechos das obras que revelam como o amor e o sexo eram importantes para Jorge Amado. Boa parte da inspiração de Jorge Amado veio das histórias contadas pela mãe, Dona Lalú, quando era criança. Essa relação está retratada no espaço “A infância/Memórias de Dona Lalú”. Nesse cantinho, há uma maquete da cidade de Ilhéus, onde o escritor, nascido no distrito de Ferradas, em Itabuna, viveu por muito tempo, e uma escultura de Jorge Amado com um ano de idade ao lado da matriarca. Já onde antes havia uma piscina está o “Lago dos sapos”, uma espécie de ranário, com sapos e rãs que tanto fascinavam o escritor, e a exibição da novela sonora baseada na obra infantil de Jorge Amado chamada “O gato malhado e a andorinha Sinhá”. No jardim, lugar mágico da casa, está o espaço "Jorge e o Candomblé" que ressalta a relação entre o Obá (posto civil que exercia no Ilê Axé Apô Afonjá) Jorge Amado e o Candomblé, com um depoimento inédito de Mãe Stella abordando a amizade com o escritor e fundamentos sobre a religião de matriz africana. No mesmo espaço, o visitante pode interagir virtualmente com Carlinhos Brown utilizando instrumentos típicos dos rituais do Candomblé. Vale lembrar que Jorge Amado, quando deputado constituinte, em 1945, foi autor da lei que assegura o direito à liberdade de culto religioso no Brasil. Leituras e sabores: “Não escrevi meu primeiro livro pensando em ficar famoso. Escrevi pela necessidade de expressar o que sentia”, disse uma vez Jorge Amado, que publicou o primeiro romance – “O país do Carnaval” – em 1931, com apenas 19 anos de idade. Após a morte, em 6 de agosto de 2001, quatro dias antes de completar 89, o mais famoso escritor brasileiro deixou 45 livros publicados, segundo a Fundação Casa de Jorge Amado. Grande parte dessas obras teve trechos lidos e gravados por artistas e familiares que podem ser vistos na residência da Rua Alagoinhas. No total, são 47 leituras em vídeo. Elas podem ser vistas no espaço “Sala das leituras”, ao lado da biblioteca, em uma tela de cinema. Entre as pessoas que fizeram leituras de trechos das obras de Jorge Amado estão nomes como Caetano Veloso, Regina Casé, Daniela Mercury, Ivete Sangalo, Sônia Braga, Mariana Ximenez, Marisa Orth, Mateus Solano, Paloma Amado, Milton Gonçalves e Paulinho da Viola. “Nessas leituras fica evidente a atemporalidade de Jorge Amado, um escritor à frente do seu tempo e que era popular porque sempre retratou o povo”, afirmou Gringo Cardia. Dois espaços são reservados à gastronomia na vida e no trabalho de Jorge Amado e Zélia Gattai: “Os amados sabores de Jorge” e “Cozinha de Dona Flor”. A quituteira Dadá ensina algumas das receitas de delícias que marcaram presenças em livros como “Dona Flor e seus dois maridos”, como a punheta (bolinho de estudante), vatapá, caruru e acarajé. Esses dois espaços foram carinhosamente preparados por Paloma Amado, filha do casal de escritores, e autora do livro “A comida baiana de Jorge Amado”, reunindo receitas e histórias de pratos típicos que aparecem nas obras do pai.`,
